<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-3xl font-bold">E-Commerce Store Manager</h1>
    ...
    <div v-if="productStore.pagination.totalPages > 1" class="mt-8 flex justify-center">
      <nav class="flex space-x-2">
        <button
            ...
            page - 1 === productStore.pagination.currentPage
...
const handleSearch = () => {
  if (searchKeyword.value.trim()) {
    productStore.searchProducts(searchKeyword.value)
  } else {
    productStore.fetchProducts(0)
  }
}
...
<style scoped>
/* Optional: Add custom styling for the component */
</style>
